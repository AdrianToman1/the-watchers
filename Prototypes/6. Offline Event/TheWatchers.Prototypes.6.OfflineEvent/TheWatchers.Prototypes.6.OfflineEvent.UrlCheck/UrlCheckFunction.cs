...
using TheWatchers.Prototypes._6.OfflineEvent.UrlCheck.CosmosService;

namespace TheWatchers.Prototypes._6.OfflineEvent.UrlCheck;
...
/// </exception>
public sealed class UrlCheckFunction(
...
)
{
    ...
    private readonly ILogger _logger = loggerFactory.CreateLogger<UrlCheckFunction>() ??
